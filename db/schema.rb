...
ActiveRecord::Schema[7.0].define(version: 20_240_422_192_037) do
  ...
  create_table 'que_jobs', comment: '7', force: :cascade do |t|
    ...
    t.index %w[job_schema_version queue priority run_at id], name: 'que_poll_idx',
    ...
    t.check_constraint "char_length(\nCASE job_class\n    WHEN 'ActiveJob::QueueAdapters::QueAdapter::JobWrapper'::text THEN (args -> 0) ->> 'job_class'::text\n    ELSE job_class\nEND) <= 200",
                       name: 'job_class_length'
    t.check_constraint 'char_length(last_error_message) <= 500 AND char_length(last_error_backtrace) <= 10000',
                       name: 'error_length'
  ...
  create_table 'que_lockers', primary_key: 'pid', id: :integer, default: nil, force: :cascade do |t|
    ...
    t.check_constraint 'array_ndims(worker_priorities) = 1 AND array_length(worker_priorities, 1) IS NOT NULL',
                       name: 'valid_worker_priorities'
  end
